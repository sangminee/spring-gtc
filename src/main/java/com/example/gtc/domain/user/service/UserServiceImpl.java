package com.example.gtc.domain.user.service;

import com.example.gtc.common.config.BaseException;
import com.example.gtc.common.config.secret.Secret;
import com.example.gtc.domain.user.entity.Following;
import com.example.gtc.domain.user.entity.User;
import com.example.gtc.domain.user.repository.FollowingJpaRepository;
...
import com.example.gtc.domain.user.repository.dto.request.PostUserEmailJoinReq;
import com.example.gtc.domain.user.repository.dto.request.PostUserPhoneJoinReq;
import com.example.gtc.domain.user.repository.dto.request.PostLoginEmailReq;
import com.example.gtc.domain.user.repository.dto.request.PostLoginNicknameReq;
import com.example.gtc.domain.user.repository.dto.request.PostLoginPhoneReq;
import com.example.gtc.common.utils.AES128;
