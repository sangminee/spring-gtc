...
import com.example.gtc.domain.comment.repository.dto.response.PostCommentReportRes;
import com.example.gtc.domain.comment.repository.dto.response.PostCommentRes;
import com.example.gtc.domain.comment.repository.dto.response.PostSuccessRes;
